      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown li">
          ...
          <ul class="dropdown-menu">
            <li><a href="login">休闲鞋</a></li>
            <li><a href="login">跑步鞋</a></li>
            <li><a href="login">滑板鞋</a></li>
            <li><a href="login">篮球鞋</a></li>
          </ul>
        </li>
