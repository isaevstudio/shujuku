 ...
 <div>
     <div style="width:60%;margin:auto auto;">
         ...
         <table class="table table-hover">
		   ...
		   <c:forEach items="${order.shoe }" var="shoe">
			<tr>
				...
				<td>${order.count}</td>
			<td>
			<a class="btn btn-info" href="buy?shoe_id=${shoe.id}" role="button">确认收货</a>
		    </td>
		    <td>
			<a class="btn btn-danger" href="removeorder?shoe_id=${shoe.id}" role="button">删除</a>
		    </td>
		  </tr>
		</c:forEach>		
		</c:forEach>		
