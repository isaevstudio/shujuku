 ...
 <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <body>
      ...
      <div style="width:15%; margin-left:45%; margin-right:auto; z-index:1;margin-top:100px;">
          <div style="margin-left:auto; margin-right:auto; "><img src="img/touxiang.png" class="img-circle"></div><div style="margin-left:80%; margin-right:auto; "><a href="stafflog"><img src="img/staff.jpg" class="img-circle"></a></div>
         ...
         <div class="btn-group btn-group-justified" role="group" aria-label="...">
            ...
            <div class="btn-group" role="group">
             ...
             <div style="margin-left:35%;"><button type="button" class="btn btn-link"><a href="findpassword">忘记密码？</a></button></div>
