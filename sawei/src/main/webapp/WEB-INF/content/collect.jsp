...
<body>
 ...
 <div style="width:60%;margin:auto auto;">
         ...
         <table class="table table-hover">  
		   ...
		   <c:forEach items="${collect.shoe }" var="shoe">
			<tr>
			...
			<td>
			<a class="btn btn-info" href="saveorder?shoe_id=${shoe.id}" role="button">购买</a>
		    </td>
		    <td>
			<a class="btn btn-danger" href="removecollect?shoe_id=${shoe.id}" role="button">取消收藏</a>
		    </td>
		  </tr>
		</c:forEach>	
		</c:forEach>		
